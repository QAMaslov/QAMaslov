...
На те части мобильного приложения ЯндексМетро, которых коснулись изменения, составлена [тестовая документация](https://docs.google.com/spreadsheets/d/e/2PACX-1vRYQqQyqeEAxZqb1A-TnRLVEIZw2zyOFMCpReSC4qOS-4tSbUZBq53fTMrZFV8vSmhtYCNoITKOqFhd/pubhtml?gid=857523888&single=true).
...
Проанализированы требования к новой функциональности бэкенда ЯндексПрилавка. Изучена документация к API в Apidoc. По итогу составлен [чек-лист](https://docs.google.com/spreadsheets/d/e/2PACX-1vRYQqQyqeEAxZqb1A-TnRLVEIZw2zyOFMCpReSC4qOS-4tSbUZBq53fTMrZFV8vSmhtYCNoITKOqFhd/pubhtml?gid=2006427015&single=true) тестирования API.
